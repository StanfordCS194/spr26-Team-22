...
private struct ExtSupabase {
    ...
    static func postInvitation(
        ...
        let body: [String: Any] = [
            "id": id,
            "from_device": SharedDefaults.deviceID,
            "from_identifier": "",
            "to_identifier": "",
            "friend_name": "",
            "activity": activity,
...
class MessagesViewController: MSMessagesAppViewController {
    ...
    private func presentUI(for conversation: MSConversation) {
        ...
        case .transcript:
            break // inline transcript bubble — no interactive UI needed
        @unknown default:
            presentCompactPicker()
        }
    }
    ...
    private func sendInvite(activity: InviteActivity, date: Date, note: String) {
        ...
        // Post to Supabase so the web RSVP link resolves and pollSentInvitations can track it.
